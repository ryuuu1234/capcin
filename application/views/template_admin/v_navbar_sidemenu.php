		...
		<div class="vd_mega-menu-wrapper">
			...
			<ul class="mega-ul">
				<li id="home" class="one-icon mega-li"> 
					<a class="mega-link  vd_bg-blue" href="<?=base_url()?>assets/admin/javascript:void(0);"  data-action="click-trigger">
						...
						<div class="child-menu">  
							...
							<div class="content-grid column-md-3 column-sm-2 column-xs-1 height-xs-auto height-sm-4">	
								...
								<div class="closing text-center" style="">
									<a href="<?=base_url()?>assets/admin/#">See All Requests <i class="fa fa-angle-double-right"></i></a>
								</div>                                                                       
							</div>                              
						</div> <!-- child-menu -->                      
				...
				<li id="tabs-menu-tasks" class="one-icon mega-li"> 
					<a class="mega-link  vd_bg-green" href="<?=base_url()?>assets/admin/javascript:void(0);"   data-action="click-trigger">
						<span class="mega-icon">
							...
							<div class="content-list content-image">	
								<div data-rel="scroll">
									<ul class="list-wrapper pd-lr-10">
										<li> <a href="<?=base_url()?>assets/admin/#"> 
										...
										<li> <a> 
											<div class="menu-icon"><img alt="example image" src="<?=base_url()?>assets/admin/img/avatar/avatar-3.jpg"></div> 
								...
								<div class="closing text-center" style="">
									<a href="<?=base_url()?>assets/admin/#">See All Tasks <i class="fa fa-angle-double-right"></i></a>
								</div>                                                                       
							</div>                              
						</div> <!-- child-menu -->                      
					</div>   <!-- vd_mega-menu-content --> 
				...
				<li id="test-2" class="one-icon mega-li"> 
					<a class="mega-link vd_bg-yellow " href="<?=base_url()?>assets/admin/javascript:void(0);" data-action="click-trigger">
						<span class="mega-icon">
						...
						<div class="child-menu">  
							...
							<div class="vd_textarea-menu vd_bg-yellow vd_bd-yellow" >
								<ul class="nav nav-pills ">
									<li class="one-icon">
										<a data-toggle="tab-post" href="<?=base_url()?>assets/admin/javascript:void(0);">
									...
									<li class="pull-right">
										<a data-toggle="tab-post" href="<?=base_url()?>assets/admin/javascript:void(0);" style="border-left:1px solid rgba(255,255,255,.3)">
											<span class="menu-icon">
				...
				<li id="test" class="one-icon mega-li"> 
					<a class="mega-link vd_bg-red" href="<?=base_url()?>assets/admin/javascript:void(0);" data-action="click-trigger">
						<span class="mega-icon">
					...
					<div class="vd_mega-menu-content  width-xs-2  center-xs-2" data-action="click-target" >
						<div class="child-menu"> 
							<div class="content-list content-menu">
								<ul class="list-wrapper pd-lr-10">
									<li> <a href="<?=base_url()?>assets/admin/#"> <span class="menu-icon"><i class=" fa fa-user"></i></span> <span class="menu-text">Write Article</span> </a> </li>
									<li> <a href="<?=base_url()?>assets/admin/#"> <span class="menu-icon"><i class=" fa fa-trophy"></i></span> <span class="menu-text">Write News</span> </a> </li>
									<li> <a href="<?=base_url()?>assets/admin/#"> <span class="menu-icon"><i class=" fa fa-flask"></i></span> <span class="menu-text">Add Product</span> </a>  </li>
