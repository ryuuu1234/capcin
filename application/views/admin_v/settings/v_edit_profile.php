					...
					<div class="panel widget light-widget panel-bd-left vd_bdl-green">
						...
						<div class="panel-body">
							<div class="row">
									...
									<form class="form-horizontal" action="#" role="form" id="add-form">
										<div class="form-group">
											...
											<div class="col-sm-7 controls">
												<input class="width-70" name="nama" type="text" placeholder="Input" data-toggle="tooltip" data-placement="top" data-original-title="Input Nama Lengkap Anda">
											</div>
										</div>
										<div class="form-group">
											<label class="col-sm-2 control-label">Username</label>
											<div class="col-sm-7 controls">
												<input class="width-70" name="username" type="text" placeholder="Input" data-toggle="tooltip" data-placement="top" data-original-title="Input Username">
											</div>
										</div>
								...
								<div class="col-md-3">
									<a href="javascript:void(0)" id="upload-link-avatar" onclick="upload_logo('<?=$this->session->userdata("user_id")?>')" >
									<div class="form-group">
                					...
                					<form action="#" id="form-image-avatar" method="post" enctype="multipart/form-data" style="margin-top:0px;">
			                            <div class="form-group">
			                              <input type="hidden" id="action_page_avatar" name="action_page_avatar" value="<?=base_url('admin/settings/profile/upload_photo/');?>"/>
...
{	
	...
	$.ajax({
		...
		{ 
			...
			var myImage = data.form.photo;
			var base_url = window.location.origin;
			var noImage = base_url+'/assets/images/users/noimage.png';
			var yesImage = base_url+'/assets/images/users/big/'+myImage;
