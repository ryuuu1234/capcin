				...
				<div class="col-md-12" id="kolomB">
					<div class="panel widget light-widget panel-bd-left ">
						...
						<div class="panel-body">
							...
							<div class="panel-body-list  table-responsive" id="table_data_koe"></div>
			...
			<div class="modal-body"> 
				<form id="add-form" action="#" class="form-horizontal" role="form">
					...
					<div class="row">
							...
							<?=textInput('barcode','off','6')?>
							<?=textInput('nama','off','6')?>
							<?=selectInput('satuan','6', $data_satuan)?>
							<?=textInput('harga_beli','off','6')?>
							<?=textInput('harga_jual_cust','off','6')?>
							<?=textInput('harga_jual_umum','off','6')?>
							<?=textInput('stok','off','4', 'number')?>
							<?=textInput('limit_stok','off','4', 'number')?>
					</div>
				</form>
			</div>
